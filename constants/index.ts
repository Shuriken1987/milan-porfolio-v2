...
export const experiences: { [key: string]: ExperienceType } = {
    Edument: {
      ...
      description: [
        "Optimized front-end application using advanced technologies to improve performance and efficiency.",
        "Implemented strategic coding practices to enhance overall application performance.",
        // "Completed advanced training courses in modern web development frameworks, including React.",
        "Improved coding proficiency and project contributions through personalized TypeScript training.",
      ],
    },
    Renax:  {
      title: "Software developer",
      ...
      description: [
        `Contributed to the development and integration of a comprehensive workforce management system, significantly improving user engagement and operational efficiency.`,
        `Played a key role in architecting and deploying interactive user interfaces using React, enhancing customer satisfaction and contributing to project success.`,
        `Improved data interactivity by integrating RESTful services and optimizing full-stack operations, reducing data retrieval times.`,
        `Maintained high standards of quality by developing testable modules and creating thorough test cases for the application.`,
      ],
    },
    Freelance:  {
      ...
      description: [
        `Developed, maintained, and shipped production code for client websites primarily using React, Next JS, and Node JS.`,
        `Integrated client applications and websites with various CMS systems using REST APIs and GraphQL.`,
        `Utilized MongoDB, PostgreSQL, and MySQL to manage and optimize data storage and retrieval for client applications.`,
        `Performed comprehensive tests on various applications to ensure functionality and performance.`,
        `Collaborated with designers, project managers, and developers to convert creative concepts into production-ready solutions for clients.`,
